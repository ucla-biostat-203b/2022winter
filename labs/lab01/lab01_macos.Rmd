...
This tutorial is for Mac users. For Windows users, please first read the [tutorial](https://ucla-biostat-203b/2022winter/labs/lab01/lab01_windows.html) to install `Git for Windows`, which ships with `Git Bash`, then most bash commands in this tutorial will work in `Git Bash`.
...
1. Install R v4.1.2 or later. <https://ftp.osuosl.org/pub/cran/> 
...
2. The Git repository git clone https://github.com/ucla-biostat-203b/2022winter.git> is frequently updated. To sync your git clone with the current repo., first enter your local repo directory
```{bash, eval=F}
cd /PATH/TO/ucla-biostat-203b/2022winter.git
```
then 
```{bash, eval=F}
git pull
