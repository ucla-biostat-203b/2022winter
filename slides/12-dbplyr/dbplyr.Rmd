...
Here, we will one csv file `icustays.csv.gz` for demonstration purpose. Motivated students can write a bash script for loading all MIMIC-IV datafiles into a SQLite database and contribute to <https://github.com/MIT-LCP/mimic-iv>.
