...
2. The `/mnt/mimiciv/1.0` folder on teaching server contains data sets from MIMIC-IV. Refer to the documentation <https://mimic-iv.mit.edu/docs/datasets/> for details of data files.  
    ```{bash}
...
1. You and your friend just have finished reading *Pride and Prejudice* by Jane Austen. Among the four main characters in the book, Elizabeth, Jane, Lydia, and Darcy, your friend thinks that Darcy was the most mentioned. You, however, are certain it was Elizabeth. Obtain the full text of the novel from <http://www.gutenberg.org/cache/epub/42671/pg42671.txt> and save to your local folder. 
    ...
    ```
Do **not** put this text file `pride_and_prejudice.txt` in Git. Tabulate the number of times each of the four characters is mentioned?
